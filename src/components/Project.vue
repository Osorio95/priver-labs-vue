<template>
    <div class="relative xl:w-[32.88%] rounded-xl overflow-hidden cursor-pointer aspect-square" @mouseover="hover = true"
        ...
        <img class="object-cover h-full w-full" :src="item.images[0]" :class="{ 'scale-125': hover }" alt="">
...
export default {
    ...
    methods: {
        emitPorfolio() {
            this.$emit('emitPorfolio', this.item)
        }
    }
}
</script>
