  ...
  <main class="relative lg:mx-28 mx-6">
    ...
    <div class="h-full lg:flex lg:flex-col justify-center">
      ...
      <p class="my-8 lg:my-4 font-normal 2xl:text-3xl text-2xl">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium maiores ipsum sapiente delectus expedita
        impedit porro libero quasi, laudantium amet voluptates? Reiciendis sint in saepe. Distinctio laudantium numquam
        cumque unde!
      </p>
      <a class="lg:my-4 w-fit lg:px-6 lg:py-4 px-3 py-2 text-center rounded-lg bg-Secondary lg:text-3xl text-xl font-bold"
        href="#">Contáctanos</a>
    </div>
    <div class="flex justify-center lg:justify-end mt-8 lg:mt-0">
      <img class="2xl:h-[618px] 2xl:w-[773px] h-96 w-auto object-contain self-center" src="../assets/imgs/box-plot-chart 1.svg"
        alt="hand using a smartphone">
    </div>
  </section> -->

    <section id="products" class="lg:overflow-hidden mx-8 lg:mx-0 text-center mb-36">
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-8 flex flex-col my-8">
        <div class="text-xl col-span-4 border-2 border-Secondary rounded-lg p-8 lg:my-0 my-4">
          ...
          <p class="inline-block">
            ...
            de startups y empresas tradicionales.
          </p>
        </div>
        <div class="text-xl col-span-4 border-2 border-Secondary rounded-lg p-8 lg:my-0 my-4">
          ...
          <p class="inline-block">
            ...
            de información y geolocalización.
          </p>
        </div>
        <div class="text-xl col-span-4 border-2 border-Secondary rounded-lg p-8 lg:my-0 my-4">
